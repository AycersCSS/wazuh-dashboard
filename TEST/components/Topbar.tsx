...
export function Topbar() {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-navy-400 bg-[rgba(18,18,18,0.95)] backdrop-blur-[8px]">
      ...
      <div className="hidden lg:flex h-7 items-center gap-3 px-4 border-t border-navy-400 text-[11px] text-navy-600">
        <span>Manager: <span className="font-mono text-cream">{typeof cluster?.manager === "string" ? cluster.manager : "—"}</span></span>
