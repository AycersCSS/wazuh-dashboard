    ...
    >
      <Card padded={false}>
        ...
        <div className="p-4 grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
          <div className="flex items-center justify-between"><span className="text-navy-600">Manager</span><span className="font-mono text-cream">{typeof cluster?.manager === "string" ? cluster.manager : "—"}</span></div>
